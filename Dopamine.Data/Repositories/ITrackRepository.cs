...
namespace Dopamine.Data.Repositories
{
    ...
    {
        Task<List<Track>> GetTracksFolderAsync(IList<string> paths);
        ...
        Task<RemoveTracksResult> RemoveSongsAsync(IList<string> pathsToRemove);
        ...
        Task<IList<AlbumData>> GetFolderAlbumDataAsync(IList<string> folders, MusicType musicType);
