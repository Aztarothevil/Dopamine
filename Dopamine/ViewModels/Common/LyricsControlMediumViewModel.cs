...
{
    public class LyricsControlMediumViewModel : ContextMenuViewModelBase
    {
        ...
        public LyricsControlMediumViewModel(IContainerProvider container) : base(container)
        {
        ...
        private async void RefreshLyricsAsync(TrackViewModel track)
        {
            ...
            try
            {
                ...
                if (lyrics != null)
                {
                    if (lyrics.SourceType != SourceTypeEnum.Audio)
                    {
        ...
        private async Task HighlightLyricsLineAsync()
        {
            ...
            await Task.Run(() =>
            {
                try
                {
                    if (this.LyricsViewModel.LyricsLines != null)
                    {
