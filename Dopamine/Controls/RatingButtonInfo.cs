...
{
    public class RatingButtonInfo : Control
    {
        private Button ratingButtonInfo;
        ...
        public static readonly DependencyProperty RatingProperty = 
            DependencyProperty.Register(nameof(Rating), typeof(int), typeof(RatingButtonInfo), new PropertyMetadata(null));
        ...
        public static new readonly DependencyProperty FontSizeProperty =
            DependencyProperty.Register(nameof(FontSize), typeof(double), typeof(RatingButtonInfo), new PropertyMetadata(11.0));

        static RatingButtonInfo()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(RatingButtonInfo), new FrameworkPropertyMetadata(typeof(RatingButtonInfo)));
        }
        ...
        public override void OnApplyTemplate()
        {
            ...
            this.ratingButtonInfo = (Button)GetTemplateChild("PART_RatingButton");
            ...
            //if (this.ratingButtonInfo != null)
            //{
            //    this.ratingButtonInfo.Click += RatingButton_Click;
            //    this.ratingButtonInfo.MouseEnter += RatingButton_MouseEnter;
            //    this.ratingButtonInfo.MouseLeave += RatingButton_MouseLeave;
            //    this.ratingButtonInfo.PreviewMouseDoubleClick += RatingButton_PreviewMouseDoubleClick;
            //}
