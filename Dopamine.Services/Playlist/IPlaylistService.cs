...
namespace Dopamine.Services.Playlist
{
    public interface IPlaylistService
    {
        ...
        Task<AddTracksToPlaylistResult> AddMusicToStaticPlaylistAsync(IList<string> artists, string playlistName);
        ...
        Task<AddTracksToPlaylistResult> AddMusicToStaticPlaylistAsync(IList<SongViewModel> albumViewModels, string playlistName);
