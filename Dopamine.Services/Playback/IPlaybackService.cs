...
namespace Dopamine.Services.Playback
{
    ...
    public interface IPlaybackService
    {
        ...
        void JumpToSecond(int timeInSeconds);
        ...
        Task EnqueueFolderAsync(FolderViewModel folder);
        ...
        Task EnqueueSongsAsync(IList<SongViewModel> songs, SongViewModel song, bool shuffle, bool unshuffle);
        ...
        Task<EnqueueResult> AddMusicToQueueAsync(IList<string> artists);
        ...
        Task<EnqueueResult> AddMusicToQueueAsync(IList<SongViewModel> albumViewModels);
